...
export const forbiddenNopeGifs = [
  ...
  { id: "blondenope", name: "BLONDE NOPE", image: "/images/blondenope.gif", type: "gif", caption: "hair said yes. machine said no." },
  { id: "catnope-loop", name: "CAT NOPE", image: "/images/catnope.gif", type: "gif", caption: "refused with unnecessary confidence." },
  { id: "craignope", name: "CRAIG NOPE", image: "/images/craignope.gif", type: "gif", caption: "Craig declined the timeline." },
  { id: "doorclosenope", name: "DOOR CLOSE NOPE", image: "/images/doorclosenope.gif", type: "gif", caption: "access denied with furniture." },
  { id: "flynope-loop", name: "FLY NOPE", image: "/images/flynope.gif", type: "gif", caption: "small wings. smaller approval." },
  { id: "foxynope", name: "FOXY NOPE", image: "/images/foxynope.gif", type: "gif", caption: "dangerously stylish refusal." },
  { id: "gingernope", name: "GINGER NOPE", image: "/images/gingernope.gif", type: "gif", caption: "spicy denial protocol." },
  { id: "lotsofheadnope", name: "TOO MANY HEADS NOPE", image: "/images/lotsofheadnope.gif", type: "gif", caption: "consensus reached. still nope." },
  { id: "lotsofnopes", name: "LOTS OF NONES", image: "/images/lotsofnopes.gif", type: "gif", caption: "several types of nothing." },
  { id: "nooope", name: "NOOOPE", image: "/images/nooope.gif", type: "gif", caption: "extended refusal detected." },
  { id: "Nope-badger", name: "NOPE BADGER", image: "/images/Nope-badger.gif", type: "gif", caption: "wildlife became unreasonable." },
  { id: "nope-bored", name: "BORED NOPE", image: "/images/nope-bored.gif", type: "gif", caption: "even the refusal lost interest." },
  { id: "nope-nope", name: "NOPE NOPE", image: "/images/nope-nope.gif", type: "gif", caption: "refusal confirmed by refusal." },
  { id: "Nopenopenope", name: "NOPE NOPE NOPE", image: "/images/Nopenopenope.gif", type: "gif", caption: "triple denial. legally excessive." },
  { id: "pupnope", name: "PUP NOPE", image: "/images/pupnope.gif", type: "gif", caption: "tiny paws. absolute rejection." },
  { id: "redlippednope", name: "RED LIPPED NOPE", image: "/images/redlippednope.gif", type: "gif", caption: "glamorous denial event." },
  { id: "sadcatnope", name: "SAD CAT NOPE", image: "/images/sadcatnope.gif", type: "gif", caption: "emotional refusal observed." },
  { id: "seanope-loop", name: "SEA NOPE", image: "/images/seanope.gif", type: "gif", caption: "ocean said absolutely not." },
  { id: "streamernope", name: "STREAMER NOPE", image: "/images/streamernope.gif", type: "gif", caption: "live reaction: denied." },
  { id: "uhhhnope", name: "UHHHH NOPE", image: "/images/uhhhnope.gif", type: "gif", caption: "hesitation became policy." },
];
...
const gifLoopTiers = {
  ...
  blondenope: { dropChance: 0.8, rarity: "glitch" },
  "catnope-loop": { dropChance: 0.8, rarity: "glitch" },
  craignope: { dropChance: 0.4, rarity: "forbidden" },
  doorclosenope: { dropChance: 0.4, rarity: "forbidden" },
  "flynope-loop": { dropChance: 0.8, rarity: "glitch" },
  foxynope: { dropChance: 0.2, rarity: "cursed" },
  gingernope: { dropChance: 0.4, rarity: "forbidden" },
  lotsofheadnope: { dropChance: 0.2, rarity: "cursed" },
  lotsofnopes: { dropChance: 0.8, rarity: "glitch" },
  nooope: { dropChance: 0.8, rarity: "glitch" },
  "Nope-badger": { dropChance: 0.2, rarity: "cursed" },
  "nope-bored": { dropChance: 0.8, rarity: "glitch" },
  "nope-nope": { dropChance: 0.4, rarity: "forbidden" },
  Nopenopenope: { dropChance: 0.1, rarity: "illegal" },
  pupnope: { dropChance: 0.8, rarity: "glitch" },
  redlippednope: { dropChance: 0.2, rarity: "cursed" },
  sadcatnope: { dropChance: 0.4, rarity: "forbidden" },
  "seanope-loop": { dropChance: 0.4, rarity: "forbidden" },
  streamernope: { dropChance: 0.2, rarity: "cursed" },
  uhhhnope: { dropChance: 0.1, rarity: "illegal" },
};
...
export const achievements = [
  ...
  { id: "telegram_public_shame", name: "PUBLIC SHAME ENABLED", description: "connected Telegram. future big wins may now be public.", reward: "+10,000 NOPE SCORE", check: ({ telegramConnectCount }) => telegramConnectCount >= 1 },
